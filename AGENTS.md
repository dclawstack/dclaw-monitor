...
**DClaw Monitor** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8030` (FastAPI)
- **Frontend Port:** `3030` (Next.js)
- **Database:** `dclaw_monitor` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3030`
